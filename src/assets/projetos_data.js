...
const projetos_data = [
    ...
    },
    {
        ...
        p_img: api2026Img,
        descricao: "Em 2026-1 desenvolvemos o Atlas, um chatbot inteligente para a Visiona Tecnologia Espacial que permite consultar dados geoambientais por meio de linguagem natural. A solução possibilita que o usuário faça perguntas como a quantidade de imóveis rurais cadastrados no CAR de um município, o número de focos de queimada ou de unidades de conservação em determinada região, e receba respostas claras e contextualizadas. Para isso, integramos uma pipeline de LLM responsável por interpretar a intenção do usuário, traduzi-la em consultas estruturadas ao banco de dados geoespacial e formatar os resultados de forma compreensível.",
        contribuicao: "Contribuições Pessoais: Product Owner - Fui responsável pelo planejamento do produto, traduzindo as necessidades do cliente em requisitos e priorizando o backlog para garantir entregas dentro do prazo. Atuei na definição das funcionalidades e do fluxo de interação do chatbot, além de implementar a lógica da pipeline de LLM responsável por interpretar as perguntas e gerar as respostas a partir dos dados geoambientais.",
        soft_skills: "SOFT SKILLS: Durante o desenvolvimento deste projeto, reforcei a importância de entender as necessidades do cliente e de traduzir requisitos técnicos complexos em uma experiência simples para o usuário final. A comunicação clara com a equipe e com o cliente foi fundamental para manter o alinhamento e garantir que o chatbot fosse intuitivo e confiável. Também desenvolvi habilidades de resolução de problemas ao lidar com os desafios de integrar inteligência artificial a consultas de dados geoespaciais.",
